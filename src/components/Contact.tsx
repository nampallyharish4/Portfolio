          ...
          <ScrollReveal direction="right" delay={400}>
            <Card3D maxTilt={5} scale={1.01}>
              <form
                ...
                className="glass-ultra p-10 rounded-[2.5rem] space-y-6 ambient-shadow"
              >
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-2xl glass-light focus:glass-medium outline-none transition-all dark:bg-transparent"
                      style={{
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-6 py-4 rounded-2xl glass-light focus:glass-medium outline-none transition-all resize-none dark:bg-transparent"
                    style={{
                      boxShadow: 'inset 0 2px 4px rgba(0,0,0,0.05)',
                    }}
